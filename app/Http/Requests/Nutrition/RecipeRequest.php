...
class RecipeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'ingredients.*.ingredient_id' => [
                'required',
                'integer',
                Rule::exists('ingredients', 'id')->where(function ($query) use ($sppgId) {
    ...
    public function messages(): array
    {
        return [
            ...
            'ingredients.*.ingredient_id.exists'   => 'Bahan baku yang dipilih tidak ditemukan di data unit Anda.',
    ...
    public function withValidator(Validator $validator)
    {
        $validator->after(function ($validator) {
            ...
            foreach ($ingredients as $item) {
                ...
                $ingredient = \App\Models\Ingredient::where('sppg_id', request()->attributes->get('sppg_id'))
            ...
            if ($totalCalorie > 0 && ($totalCalorie < 2000 || $totalCalorie > 2700)) {
                $validator->errors()->add('ingredients', 'Total kalori belum memenuhi target. (Total: ' . round($totalCalorie, 2) . ' kkal, Target: 2000-2700 kkal)');
            }
        });
    }
}